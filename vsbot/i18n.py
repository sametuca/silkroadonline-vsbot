...
_STRINGS = {
    ...
    "detection_mode": {"EN": "Detection (OCR)", "TR": "Tespit (OCR)"},
    "err_no_ocr": {"EN": "OCR isn't available yet - install Tesseract below first.",
                   "TR": "OCR henüz kullanılamıyor - önce aşağıdan Tesseract'ı kurun."},
